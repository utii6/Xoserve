...
# تحديث هيكل قاعدة البيانات (استخدام BIGINT للايدي وسيريال للبيانات)
...
def start(message):
    ...
    if row is None:
        ...
        cursor.execute('INSERT INTO users (user_id, referred_by) VALUES (%s, %s)', (uid, referrer))
        conn.commit()
...
if __name__ == "__main__":
    keep_alive()
    bot.remove_webhook()
    print("🚀 البوت يعمل بنظام Postgres طبق الأصل...")
