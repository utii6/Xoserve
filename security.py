...
# دالة معالجة الإجابة وتسجيل المستخدم
def process_captcha(bot, call, get_db_connection, show_main_menu):
    ...
    if pressed == correct:
        ...
        show_main_menu(call.message) # فتح قائمة البوت
    else:
